 ...
 * Descrição: Lógica de interações, modais, PWA com memória
 * de instalação, formulário, OneSignal, Service Worker,
 * banner LGPD, botão de tradução e menu mobile
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const jaInstalou = localStorage.getItem('vitaotub_pwa_installed');
    if (!isStandalone && !jaRejeitou && !jaInstalou) {
        setTimeout(() => {
...
function translatePage(lang) {
    if (lang === 'pt') {
        // Força o Google Tradutor a voltar ao idioma original
